...
import { ExternalLink, Send, Image as ImageIcon, Link as LinkIcon } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-20">
            <div className="flex items-center justify-between mb-5">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Save the Date</h1>
                    <p className="text-slate-500 mt-1">Review raw data and provide references for your Save the Date deliverables.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col relative overflow-hidden">
                    ...
                    <p className="text-sm text-slate-500 mb-6 flex-1">
                        Your production team has uploaded the raw photos. Please review them using the secure link below.
                    </p>
                ...
                <div className="md:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col">
                    ...
                    <p className="text-sm text-slate-500 mb-4">
                        Type the file numbers of the images you'd like us to use for the Save the Date post (e.g., IMG_1042, IMG_1088).
                    </p>
